...
######  --input-path /Users/pierre-louisstenger/Documents/PostDoc_02_MetaBarcoding_IAC/02_Data/07_Aquaculture_interspecies_assemblages/Aquaculture_interspecies_assemblages/98_database_files/silva_nr99_v138_wSpecies_train_set.fa \
